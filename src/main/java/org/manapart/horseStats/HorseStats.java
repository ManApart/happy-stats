...
@Mod(HorseStats.MODID)
@Mod.EventBusSubscriber(modid = HorseStats.MODID)
public class HorseStats {

    static final String MODID = "horsestats";

    public HorseStats() {
        MinecraftForge.EVENT_BUS.register(this);
        FMLJavaModLoadingContext.get().getModEventBus().addListener(this::getHorseStats);
    }

    @SubscribeEvent
    public void getHorseStats(PlayerInteractEvent.EntityInteract event) {
